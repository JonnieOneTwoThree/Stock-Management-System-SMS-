...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ){
    ...
    do {
        if ( empty($stock_name) || empty($entry_date) || empty($supplier_name) ||
             empty($supplier_number)|| empty($stock_description) || empty($stock_quantity) ) {
        ...
        $sql = "INSERT INTO add_new_stock (stock_name, entry_date, supplier_name, supplier_number, stock_description, stock_quantity) ".
                    "VALUES ('$stock_name', '$entry_date', '$supplier_name', '$supplier_number', '$stock_description', '$stock_quantity')";
        ...
        $successMessage = "Stock Recorded successfully";
...
<nav class="navbar navbar-dark bg-dark fixed-top">
    ...
    <center><h2>ADD NEW STOCK:</h2></center><br>
    ...
    <form method="post">
        ...
        <!-- second row -->
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label">Entry Date</label>
            <div class="col-sm-6">
        ...
        <div class="row mb-3">
         ...
         <!-- fourth row -->
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label">Stock Description</label>
            <div class="col-sm-6">
