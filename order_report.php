...
<nav class="navbar navbar-dark bg-dark fixed-top">
                ...
                <li class="nav-item dropdown">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="/myshop/payment_report.php">Paymeny Report</a></li>
                    </ul>
                    <li class="nav-item">
    ...
    <div class="container my-5">
        <center><h2><u>ORDERS REPORT:</u></h2></center>
