...
<nav class="navbar navbar-dark bg-dark fixed-top">
    ...
    <div class="container my-5">
        <center><h2><u>LIST OF STOCK AVAILABLE:</u></h2></center>
        <!-- <a class="btn btn-primary" href="/myshop/create.php" role="button">ADD NEW STOCK</a> -->
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><p>$row[entry_date]</p></td>
                        <td><p>$row[supplier_name]</p></td>
                        <td><p>$row[supplier_number]</p></td>
                        <td><p>$row[stock_description]</p></td>
                        <td><p>$row[stock_quantity]</p></td>
                        <td>
                            <a class='btn btn-primary btn-sm' href='/myshop/edit.php?id=$row[id]'>EDIT</a>
                            <a class='btn btn-danger btn-sm' href='/myshop/delete.php?id=$row[id]'>delete</a>
                            <a class='btn btn-success btn-sm' href='/myshop/edit2.php?id=$row[id]'>Dispatch</a>
                        </td>
                    </tr>
                    ";
                }
