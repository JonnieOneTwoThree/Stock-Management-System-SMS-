...
if ( $_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $id = $_GET["id"];
     ...
     $sq = "SELECT * FROM order_stock WHERE id=$id";
    ...
    do {
        ...
        $successMessage = " fyfrdtrdtsuccessfull";
...
<nav class="navbar navbar-dark bg-dark fixed-top">
    ...
    <center><h2><u>MAKE PAYMENTS OF STOCK:</u></h2></center>
    <br>
    <?php
    ...
    <form method="post">
        ...
        <!-- second row -->
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label">date_of_order</label>
            <div class="col-sm-6">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="stock_quantity" value="<?php echo $stock_quantity;?>">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-3 d-grid">
                <a class="btn btn-outline-primary" href="/myshop/view_orders_made.php" role="button">cancel</a>
            </div>
        </div>
    </form>
    </div>
